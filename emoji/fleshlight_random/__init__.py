...
def fleshlight_random(images: list[BuildImage], texts: list[str], args: MemeArgsModel):
    ...
    #0. fleshlight_air_play(空气玩法)
    #1. fleshlight_angel(天使心)
    #2. fleshlight_cleaning_liquid(清洗液)
    #3. fleshlight_commemorative_edition_saint_sister(纪念版圣修女)
    #4. fleshlight_hoshino_alice(啦啦队偶像/拉拉队偶像)
    #5. fleshlight_idol_heartbeat(偶像心跳)
    #6. fleshlight_jissbon(杰士邦)
    #7. fleshlight_kuileishushi(白丝壁女)
    #8. fleshlight_limited_edition_saint_sister(限定版圣修女)
    #9. fleshlight_liuli_zi(琉璃子)
    #10. fleshlight_machinery(机械龙女/机械龙女EVA/机械龙女eva)
    #11. fleshlight_mengxin_packs(萌新礼包)
    #12. fleshlight_miyuko_kamimiya(神宫美优子)
    #13. fleshlight_mizuki_shiranui(水城不知火)
    #14. fleshlight_nrn(乳入娘)
    #15. fleshlight_pure_buttocks(纯洁臀)
    #16. fleshlight_purple_spirit(紫域精灵)
    #17. fleshlight_qiaobenyouxi(桥本友希)
    #18. fleshlight_saint_sister(圣修女)
    #19. fleshlight_saki_haruna(春奈纱希)
    #20. fleshlight_selena(魔女之森)
    #21. fleshlight_starter_pack(新手礼包)
    #22. fleshlight_summer_liuli_zi(夏日琉璃子)
    #23. fleshlight_taimanin_asgi(对魔忍)
    #24. fleshlight_xingnai(杏奈)
    ...
    text_positions = [
        ...
        (0, 1037, 339, 1106),    # 图片2.png的文本位置
        (40, 110, 374, 207),   # 图片3.png的文本位置
        (0, 1037, 339, 1106),    # 图片4.png的文本位置
        ...
        (835, 394, 1119, 464),   # 图片15.png的文本位置
    ...
    #
    # position: (x, y) 坐标，size: (width, height) 尺寸
    avatar_configs = [
        ...
        {"position": (-160, -50), "size": (920, 920)},  # 图片15.png的头像配置
